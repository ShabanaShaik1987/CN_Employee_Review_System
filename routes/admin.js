...
// Add this route to render the update form
router.get('/updateEmployee/:id',  passport.checkAuthentication ,adminController.updateEmployeeForm);

// Add this route to handle the update POST request
router.post('/updateEmployee/:id',  passport.checkAuthentication ,adminController.updateEmployee);
